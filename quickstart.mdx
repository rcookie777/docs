...
<Steps>
  <Step title="Sign In">
    Click "Sign In" in the top right corner of the platform to create your account.
    ...
    **Getting started:**
    ...
    <Tip>
      You can trade on both Polymarket and Kalshi markets from the same account.
    </Tip>
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Rewards" icon="gift" href="/rewards">
...
<Steps>
  ...
  <Step title="Explore Trading Strategies">
  ...
  <Step title="Earn Rewards">
    Start earning points and referral bonuses
